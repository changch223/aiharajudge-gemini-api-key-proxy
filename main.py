...
以下の9種類のハラスメントについて、各項目を0〜100点で数値化してください。
...
また、「総合コメント」では、AIが分析結果に応じたアドバイスや注意点を提示し、
利用者の不安を和らげるようなメッセージを含めてください。
コメントは、安心して次の一歩を踏み出せるようサポートする内容でお願いします。

答えは必ず strict な JSON のみで返してください。
"""
